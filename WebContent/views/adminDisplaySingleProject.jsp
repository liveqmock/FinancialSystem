...
<body>
	...
	<div class="respond" style='margin-left: 9cm; margin-right: 2cm'>
		...
		<h3>修改项目信息</h3>
		<form action='adminUpdateProjectAction' method='post'>
			<input type="hidden" name="p_id"
				value="<s:property value='project.p_id' />" /> <label
				style="font-size: 18px;">项目名称: </label>
			<textarea name="p_name"
				style="margin-right: 10cm; width: 20%; repeat: repeat-x;" cols="62"
				rows="1" value=""><s:property value='project.p_name' /></textarea>
			<hr />
			<label style="font-size: 18px;">项目主持人: </label>
			<textarea name="host_name"
				style="margin-right: 10cm; width: 20%; repeat: repeat-x;" cols="62"
				rows="1" value=""><s:property value='project.host_name' /></textarea>
			<hr />
			<label style="font-size: 18px;">总经费: </label>
			<textarea name="money"
				style="margin-right: 10cm; width: 20%; repeat: repeat-x;" cols="62"
				rows="1" value=""><s:property value='project.money' /></textarea>
			<hr />
			<label style="font-size: 18px;">开始时间: </label>
			<textarea name="start_time"
				style="margin-right: 10cm; width: 20%; repeat: repeat-x;" cols="62"
				rows="1" value=""><s:property value='project.start_time' /></textarea>
			<hr />
			<label style="font-size: 18px;">结束时间: </label>
			<textarea name="end_time"
				style="margin-right: 10cm; width: 20%; repeat: repeat-x;" cols="62"
				rows="1" value=""><s:property value='project.end_time' /></textarea>
			<hr />
			<label style="font-size: 18px;">差旅报销比例: </label>
			<textarea name="travel_ratio"
				style="margin-right: 10cm; width: 20%; repeat: repeat-x;" cols="62"
				rows="1" value=""><s:property
					value='project.travel_ratio' /></textarea>
			<hr />
			<label style="font-size: 18px;">设备报销比例: </label>
			<textarea name="device_ratio"
				style="margin-right: 10cm; width: 20%; repeat: repeat-x;" cols="62"
				rows="1" value=""><s:property
					value='project.device_ratio' /></textarea>
			<hr />
			<label style="font-size: 18px;">其他报销比例: </label>
			<textarea name="others_ratio"
				style="margin-right: 10cm; width: 20%; repeat: repeat-x;" cols="62"
				rows="1" value=""><s:property
					value='project.others_ratio' /></textarea>
			<hr />
