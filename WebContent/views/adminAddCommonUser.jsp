...
<body>
	...
	<div class="respond" style='margin-left: 9cm; margin-right: 2cm'>
		<form action='adminAddCommonUser' method='post'>
			<br /> <label style="font-size: 18px;">名字: </label>
			<textarea name="name"
				style="margin-right: 10cm; width: 20%; repeat: repeat-x;" cols="62"
				rows="1"><s:property value='commonUser.name' /></textarea>
			<hr />

			<label style="font-size: 18px;">绑定银行卡号: </label>
			<textarea name="bank_card"
				style="margin-right: 10cm; width: 20%; repeat: repeat-x;" cols="62"
				rows="1"><s:property value='commonUser.bank_card' /></textarea>
			<hr />

			<label style="font-size: 18px;">密码: </label> <input type='password'
				name="password"
				style="margin-right: 10cm; width: 20%; repeat: repeat-x;" cols="62"
				rows="1"></input>
			<hr />

			<label style="font-size: 18px;">再输一遍密码: </label> <input
