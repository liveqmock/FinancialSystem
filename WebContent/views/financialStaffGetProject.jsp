							...
							<div class="nav-collapse collapse navbar-responsive-collapse">
								<ul class="nav">
									<li class="divider-vertical"><a
										href='<s:url action='financialStaffGetProjectAction'></s:url>'>报销审核</a></li>
								</ul>
		...
		<div class="row-fluid">
			<div class="span8">
				...
				<s:iterator value="projects" id="project">
					<h2>
						<s:property value="#project.c_identifier" />
						&nbsp&nbsp
					...
					<p>
						state:&nbsp&nbsp
						<s:property value="#project.state" />
					</p>
					<p>
						<a class='btn'
							href='<s:url action='financialStaffUpdateStateAction'><s:param name='p_id' value='#project.p_id'/><s:param name='c_id' value='#project.c_identifier'/><s:param name='state' >financial_agree</s:param></s:url>'>Agree</a>
						<a class='btn'
							href='<s:url action='financialStaffUpdateStateAction'><s:param name='p_id' value='#project.p_id'/><s:param name='c_id' value='#project.c_identifier'/><s:param name='state' >submitted</s:param></s:url>'>Disagree</a>
					</p>
					<hr>
				</s:iterator>
			</div>
