...
<body>
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span8">
				<a style="font-size: 22pt; color: grey"> 主持项目列表 </a>
				<hr>

				<s:iterator value="hostProjects" id="project">
					<h2>
					...
					<p>
						<a class='btn'
							href='<s:url action='displayHostProjectAction'><s:param name='p_id' value='#project.p_id'/></s:url>'>View
							deatils »</a>
					</p>
					<hr>
				</s:iterator>
				...
				<%-- <h2>
					title <span class='date' style='font-size: 15px'>时间</span>
				</h2>

				<p>内容</p>

				<p>
					<a class='btn' href='#'>View deatils »</a>
				</p>
