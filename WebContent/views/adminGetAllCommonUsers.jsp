...
<body>
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span8">
				<a style="font-size: 22pt; color: grey"> 用户列表 </a>
				<hr>
				...
				<s:iterator value="users" id="user">
					...
					<p>
						<a class='btn'
							href='<%=request.getContextPath()%>/views/adminDisplayCommonUser.jsp?identifier=<s:property value="#user.identifier"/>&name=<s:property value="#user.name"/>&bank_card=<s:property value="#user.bank_card"/>' />View
						deatils »</a>
					</p>
					<hr>
				</s:iterator>
